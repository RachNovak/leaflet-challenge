...
function createFeatures(earthquakeData) {
  ...
  function getColor(feature) {
    ...
    let mycolor = "none";
    if (depth > 90) { mycolor = "red" }
    else if (depth > 70) { mycolor = "orange" }
    else if (depth > 50) { mycolor = "yellow" }
    else if (depth > 30) { mycolor = "green" }
    else if (depth > 10) { mycolor = "blue" }
    return (mycolor)
  }
...
function createMap(earthquakes) {
  ...
  legend.onAdd = function (map) {
    ...
    div.innerHTML += '<i style="background: #green"></i><span>30-50</span><br>';
    div.innerHTML += '<i style="background: #yellow"></i><span>50-70</span><br>';
    div.innerHTML += '<i style="background: #organge"></i><span>70-90</span><br>';
